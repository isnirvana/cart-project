...
import { confirmOrderInCart } from "../js/confirmation.js"
...
confirmOrder.addEventListener("click", confirmOrderInCart)
...
function addToCart(event) {
  ...
  const productCategory = targetEvent.querySelector(".product-category")
  let id = Date.now()
  id++
  ...
  const totalProduct = parseFloat(productPrice.textContent.slice(1))
  ...
  cart.push({ productName: productName.textContent, productCategory: productCategory.textContent, id: id })
